...
-------------------------------------------------
DBCC TRACEON(0, 3604,1200) WITH NO_INFOMSGS;
...
--READ COMMITED: 
--keine Zeilensperren!! auch bei Index, da keine Datenänderungen durchgeführt werden
...
--Bulk_operation -S Sperre: 
--kein Lesen auf neue unformatierte Datenseiten während des Lesens
...
--bis auf die entsprenchende Zeile, die erst am Ende der Transaction 
--freigegeben wird
...
--READ COMMITED
--Hier wird nun noch die entprechende Datenseite gesperrt
...
DBCC PAGE ('testdb', 1, 20000, 3) WITH TABLERESULTS;
